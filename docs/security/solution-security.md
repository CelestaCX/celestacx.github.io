...
| PCI DSS | ⚠️ Partially compliantCall transcript auto-redaction is not natively available | Network isolation capable, no default passwords, TLS in transit, RBAC, 2FA, CI/CD scanning. Pause-and-resume recording supports cardholder data handling. | 
