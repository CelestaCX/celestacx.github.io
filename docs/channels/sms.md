...
| Toll-Free  Number | A  toll-free  number  enabled  for  SMS  (US/Canada) | Two-way  SMS,  moderate  volumes,  consumer-friendly | **Important:** Two-way SMS (inbound and outbound) requires a long code, short code, or toll-free number. Alphanumeric sender IDs are outbound only — customers cannot reply to them. Ensure your number type matches your use case before provisioning. 
---
...
| Do  Not  Contact  lists | Opted-out  numbers  must  be  maintained  on  a  suppression  list  and  excluded  from  future  sends. | CelestaCX provides the technical capability to send and receive SMS — compliance with applicable regulations is the responsibility of your organisation. Engage your legal team before launching SMS communications. 
---
